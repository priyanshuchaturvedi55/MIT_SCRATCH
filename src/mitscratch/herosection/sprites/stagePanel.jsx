...
const StagePanel = ({
  ...
  return (
    <div className="w-full h-96 bg-white border-2 border-gray-300 relative overflow-hidden rounded-lg">
      ...
      <div className="absolute top-2 right-2 bg-white bg-opacity-90 border border-gray-300 rounded p-2 text-xs z-20">
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-1">
            <div className="w-3 h-1 bg-gray-400 rounded" style={{ background: 'repeating-linear-gradient(90deg, #666 0, #666 3px, transparent 3px, transparent 6px)' }}></div>
            <span>Trail</span>
          </div>
        </div>
      </div>
